...
public class Bo2mCarDTOService {
    ...
    private final Bo2mCarDTOSearchRepository bo2mCarDTOSearchRepository;

    public Bo2mCarDTOService(Bo2mCarDTORepository bo2mCarDTORepository, Bo2mCarDTOSearchRepository bo2mCarDTOSearchRepository) {
        this.bo2mCarDTORepository = bo2mCarDTORepository;
        this.bo2mCarDTOSearchRepository = bo2mCarDTOSearchRepository;
    }
    ...
    public Bo2mCarDTO save(Bo2mCarDTO bo2mCarDTO) {
        ...
        Bo2mCarDTO result = bo2mCarDTORepository.save(bo2mCarDTO);
        bo2mCarDTOSearchRepository.save(result);
        return result;
    }
    ...
    public void delete(Long id) {
        ...
        bo2mCarDTOSearchRepository.deleteById(id);
    }

    /**
     * Search for the bo2mCarDTO corresponding to the query.
     *
     ...
     */
    @Transactional(readOnly = true)
    public Page<Bo2mCarDTO> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of Bo2mCarDTOS for query {}", query);
        return bo2mCarDTOSearchRepository.search(queryStringQuery(query), pageable);    }
}
