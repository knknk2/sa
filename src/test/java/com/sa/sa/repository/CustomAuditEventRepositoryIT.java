...
import com.sa.sa.config.audit.AuditEventConverter;
import com.sa.sa.domain.PersistentAuditEvent;
...
import static com.sa.sa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
