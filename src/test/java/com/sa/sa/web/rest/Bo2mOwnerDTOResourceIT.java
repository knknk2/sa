...
public class Bo2mOwnerDTOResourceIT {
     ...
     *
     * @see com.sa.sa.repository.search.Bo2mOwnerDTOSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createBo2mOwnerDTO() throws Exception {
        ...
        // Validate the Bo2mOwnerDTO in Elasticsearch
        verify(mockBo2mOwnerDTOSearchRepository, times(1)).save(testBo2mOwnerDTO);
    }
    ...
    public void createBo2mOwnerDTOWithExistingId() throws Exception {
        ...
        // Validate the Bo2mOwnerDTO in Elasticsearch
        verify(mockBo2mOwnerDTOSearchRepository, times(0)).save(bo2mOwnerDTO);
    }
    ...
    public void updateBo2mOwnerDTO() throws Exception {
        ...
        reset(mockBo2mOwnerDTOSearchRepository);
    ...
    public void deleteBo2mOwnerDTO() throws Exception {
        ...
        // Validate the Bo2mOwnerDTO in Elasticsearch
        verify(mockBo2mOwnerDTOSearchRepository, times(1)).deleteById(bo2mOwnerDTO.getId());
    }

    @Test
    @Transactional
    public void searchBo2mOwnerDTO() throws Exception {
        // Initialize the database
        bo2mOwnerDTOService.save(bo2mOwnerDTO);
        when(mockBo2mOwnerDTOSearchRepository.search(queryStringQuery("id:" + bo2mOwnerDTO.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(bo2mOwnerDTO), PageRequest.of(0, 1), 1));
        // Search the bo2mOwnerDTO
        restBo2mOwnerDTOMockMvc.perform(get("/api/_search/bo-2-m-owner-dtos?query=id:" + bo2mOwnerDTO.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(bo2mOwnerDTO.getId().intValue())))
